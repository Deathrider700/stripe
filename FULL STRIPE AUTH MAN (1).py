...
r1 = r.get('https://caretuition.co.uk/my-account/', headers=headers)
...
r2 = r.post('https://caretuition.co.uk/my-account/', headers=headers, data=data)
...
r3 = r.get('https://caretuition.co.uk/my-orders/payment-methods/', headers=headers)
...
r4 = r.get('https://caretuition.co.uk/my-orders/add-payment-method/', headers=headers)
...
r6 = r.post('https://caretuition.co.uk/', params=params, cookies=cookies, headers=headers, data=data)
